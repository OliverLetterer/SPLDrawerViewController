...
#define COCOAPODS_POD_AVAILABLE_SPLDrawerViewController
#define COCOAPODS_VERSION_MAJOR_SPLDrawerViewController 0
#define COCOAPODS_VERSION_MINOR_SPLDrawerViewController 1
#define COCOAPODS_VERSION_PATCH_SPLDrawerViewController 0
